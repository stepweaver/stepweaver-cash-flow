        ...
        {receipts.length > 1 && (
          <div className='flex items-center justify-between p-4 bg-terminal-dark border-b border-terminal-border'>
            <button
              ...
              className='px-3 py-1 text-sm bg-terminal-green text-black rounded hover:bg-terminal-green/80 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-ocr'
            >
              ← Previous
            </button>
                ...
                {isImage(currentReceipt) ? (
                  imageError ? (
                    <div className='text-center p-8'>
                      ...
                      <p className='text-terminal-muted font-ocr mb-2'>
                        Unable to display image
                      </p>
                      <button
                        onClick={() => handleDownload(currentReceipt)}
                        className='text-terminal-blue hover:text-terminal-blue/80 underline font-ocr'
                      >
                        Download to view
                      </button>
                    </div>
                  ...
                  <div className='text-center p-8'>
                    ...
                    <div className='space-y-2'>
                      <button
                        ...
                        className='block w-full px-4 py-2 bg-terminal-blue text-white rounded hover:bg-terminal-blue/80 transition-colors font-ocr'
                      >
                      ...
                      <button
                        onClick={() => handleDownload(currentReceipt)}
                        className='block w-full px-4 py-2 bg-terminal-green text-black rounded hover:bg-terminal-green/80 transition-colors font-ocr'
                      >
                  ...
                  >
                    <div className='flex items-center space-x-2'>
                      ...
                      <div className='flex-1 min-w-0'>
                        <p className='text-xs font-medium text-terminal-text font-ocr truncate'>
